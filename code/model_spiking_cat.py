...
def simulate(lesioned_trials, lesion_cell_inds, lesion_mean, lesion_sd,
    ...
    np.save('../output/model_spiking_' + fig_label + 'w_vis_dms_A_rec.npy', w_vis_dms_A_rec)
    np.save('../output/model_spiking_' + fig_label + 'w_vis_dms_B_rec.npy', w_vis_dms_B_rec)
    np.save('../output/model_spiking_' + fig_label + 'w_vis_pm_A_rec.npy', w_vis_pm_A_rec)
    np.save('../output/model_spiking_' + fig_label + 'w_vis_pm_B_rec.npy', w_vis_pm_B_rec)
...
def load_simulation(fig_label):
    ...
    w_vis_dms_A_rec = np.load('../output/model_spiking_' + fig_label + 'w_vis_dms_A_rec.npy')
    w_vis_dms_B_rec = np.load('../output/model_spiking_' + fig_label + 'w_vis_dms_B_rec.npy')
    w_vis_pm_A_rec = np.load('../output/model_spiking_' + fig_label + 'w_vis_pm_A_rec.npy')
    w_vis_pm_B_rec = np.load('../output/model_spiking_' + fig_label + 'w_vis_pm_B_rec.npy')
...
def plot_simulation(fig_label):
    ...
    ax.plot(trials, mean_p, color='C1', linestyle='--', marker='o', label='Prediction (p)')
